...
[centres, ceil(probabilitesInitiales*100) ,largeurs_gauches, largeurs_droites]
plot((1:length(peigneGaussienne))/facteur-1,    peigneGaussienne), grid on, axis([0 20 0 1]);